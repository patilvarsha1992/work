        ...
        while True:
            ...
            if (flag_check_specified_pattern[0] == 'Y'):
                ...
                for email in emails_pattern:
                                ...
                                if len(blocks) > 0:
                                    ...
                                    if len(match_email) > 0:
                                        for each_email in match_email:
                                            ...
                                            junk_url = ["skymem.info", "directory.email-verifier.io",
                                                        'publicemailrecords.com', "issuu.com", "rocketreach.co", "ftp:",
                                                        "groups.google.com", "skymem.net",
                                                        "emailbiz.info", "emaildownload.org", "emaildatalist.net"]

                                            good_domains = ["linkedin.com", "facebook.com", "wikileaks.org",
                                                            "businesscommunity.it", "github.com",
                                                            "twitter.com", "scribd.com", "slideshare.net"]

                                            good_domains1 = ["app.lead411.com", "lead411.com", "wikileaks.org",
                                                             "quanki.com"]  # set score = (score*.9)
                                            business_domains2 = ["businesswire.com", "onlinelibrary.wiley.com",
                                                                 "researcher.ibm.com", "thalamus.co",
                                                                 "hcpreports.blogspot.com"]  # set score = (score*1.1)
                                            acdamic_domain = ["academia.edu",
                                                              "novasbe.unl.pt"]  # set score = (score*1.25)
                                            good_domains3 = ["ietf.org"]  # set score = (score*1.2)
                                            flag1 = False
                                            flag0 = False
                                            print "flag", flag1
                                            for j_d in junk_url:
                                            ...
                                            if flag0 is False:
                                                for g_d in good_domains:
                                                    if g_d in get_url:
                                                        temp2 = (cal_score + ((100 - cal_score) / 2.))  # 75
                                                        flag1 = True
                                                        break

                                                for g_d1 in good_domains1:
                                                    if g_d1 in get_url:
                                                        temp2 = (cal_score * .9)  # 45
                                                        flag1 = True
                                                        break

                                                for g_d2 in business_domains2:
                                                    if g_d2 in get_url:
                                                        temp2 = (cal_score * 1.1)  # 55
                                                        flag1 = True
                                                        break

                                                for g_d3 in good_domains3:
                                                    if g_d3 in get_url:
                                                        temp2 = (cal_score * 1.2)  # 60
                                                        flag1 = True
                                                        break

                                                for ac_d in acdamic_domain:
                                                    if ac_d in get_url:
                                                        temp2 = (cal_score * 1.25)  # 62.5
                                                        flag1 = True
                                                        break

                                                if got_email2 is True:
                                                    if flag1 is True:
                                                        temp = (
                                                        temp2 + ((100 - temp2) / 1.5))  # 91.6 ,81.6, 75, 66.66, 87.5,
                                                        tmp_row.append(temp)
                                                    else:
                                                        temp = (cal_score + ((100 - cal_score) / 1.5))  # 83.33
                                                        tmp_row.append(temp)
                                                else:
                                                    if flag1 is False:
                                                        tmp_row.append(cal_score)
                                                    else:
                                                        tmp_row.append(temp2)
                    ...
                    all_combination_field="INSERT INTO "+output_table_name+ "(li_id,experience_id,search_url,found_url,date,email,capture_all,domain_matches_url_domain,pattern,any_pattent,score) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                    cap_all_and_domain="INSERT INTO " +output_table_name+ "(li_id,experience_id,search_url,found_url,date,email,capture_all,domain_matches_url_domain,score) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)"
